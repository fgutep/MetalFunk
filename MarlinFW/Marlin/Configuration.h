...
#define STRING_CONFIG_H_AUTHOR "(YEISON R)" // Who made the changes.
...
#define Z_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop. //[BS]
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 99.5, 99.5, 4000, 393}
 ...
 *     O-- FRONT --+
 */
//#define NOZZLE_TO_PROBE_OFFSET { 0, 23, 0.0 }
