...
#define STRING_CONFIG_H_AUTHOR "(Fgutep, MetalHunk)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "MetalHunk"
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW //! Endstop invert cambiar si necesario
#define X_MAX_ENDSTOP_HIT_STATE HIGH
#define Y_MIN_ENDSTOP_HIT_STATE LOW //! Endstop invert cambiar si necesario
#define Y_MAX_ENDSTOP_HIT_STATE HIGH
#define Z_MIN_ENDSTOP_HIT_STATE HIGH //! Endstop invert cambiar si necesario
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 150, 5000 }
